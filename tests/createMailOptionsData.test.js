...
//         before(()=>{
//             ejsSendMailSinon = sinon.stub(ejsSendMail,'send')
//         })

//         beforeEach(()=>{
//             ejsSendMailSinon.reset()
//         })

//         after(()=>{
//             ejsSendMailSinon.restore()
//         })

//         const mailData = await ejsSendMailSinon

//         console.log('createMailOptionsData mailData: ',mailData)
...
//         assert.throws(()=>createMailOptionsData(),'mailData wasn´n informed')
//     })
...
//         assert.throws(()=>createMailOptionsData(sendMailData),'to should be set')
//     })
// })